...
public class OperateMacUnconfirmedDataUp implements OperateMacPkt {
    ...
    public MacPktForm MacParseData(byte[] data, String gatawayId, String syscontent) {
      ...
      /*
        ...
        Base64Utils.myprintHex(macunconfirmeddataup.DevAddr);
        ...
        redisDB.jedisPool.getResource().set(Base64Utils.toHex(macunconfirmeddataup.DevAddr) + "NwkSKey", ObjectToString.byteToStr(nwk1));
        redisDB.jedisPool.getResource().set(Base64Utils.toHex(macunconfirmeddataup.DevAddr) + "AppSKey", ObjectToString.byteToStr(nwk1));
        ...
        Base64Utils.myprintHex(macunconfirmeddataup.Fcnt);
        ...
        Base64Utils.myprintHex(macunconfirmeddataup.Fopts);

        System.arraycopy(data, 8 + foptlen, macunconfirmeddataup.Fport, 0, 1);
        System.out.print("Fport:");
        Base64Utils.myprintHex(macunconfirmeddataup.Fport);
        int framelen;
        ...
        Base64Utils.myprintHex(macunconfirmeddataup.FRMPayload);
        String lightupmac = HextoString.convertHexToString(Base64Utils.recvtohex(macunconfirmeddataup.FRMPayload));
...
//            nodeid = nodeid + hex;
//        }
        String nodeid = Base64Utils.BytetoHex(macunconfirmeddataup.DevAddr);
...
//        System.out.println(macunconfirmeddataup.fctrl.RFU);
        ...
        Base64Utils.myprintHex(appSKey);
        System.arraycopy(macunconfirmeddataup.Fcnt, 0, fcnt, 0, 2);
...
/*        // 对于 FRMPayload 要进行解密测试
        try {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                System.out.print("FRMPayload:");
                Base64Utils.myprintHex(FRMPayload);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
/*            //beacon receive
            ...
            try {
                ...
                Base64Utils.myprintHex(pingoffset);
